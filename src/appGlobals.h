...
#define INCLUDE_AUDIO false   // audio.cpp (microphone)
#define INCLUDE_PERIPH false  // peripherals.cpp
...
#define INCLUDE_MCPWM false   // mcpwm.cpp (motor control)
...
void getBootCount();
void prepUartRAT();
extern byte uartBuffTx[256];//RAT
extern byte uartBuffRx[256];//RAT
extern int uartReadCount;//RAT
extern int uartWriteCount;//RAT
